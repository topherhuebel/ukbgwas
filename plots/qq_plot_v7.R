...
qq.plot <- function( x, alpha=0.05, datatype="pvalue", scaletype="pvalue", df=1, plot.concentration.band=TRUE, one.sided=FALSE, frac=1, iplot=NULL, print=FALSE, xat=NULL, yat=NULL, main=NULL, xlab=NULL, ylab=NULL, pch="x", cex=0.5, cex.lab =1.5, cex.axis=2.0, cex.main=2.0, col="black", ... )
{
  ...
  plot( c(E[1],E[length(E)]), c(O[1],O[length(O)]), main = main, xlab = xlab, ylab = ylab, type = "n", xaxt = "n", yaxt = "n", cex.lab = cex.lab, cex.axis = cex.axis, cex.main=cex.main, ... )       #Just plots the outside box
  axis(1, at=xnums, labels=Lx, cex.axis=1.5)
  axis(2, at=ynums, labels=Ly, cex.axis=1.5)
...
## make qq plots
png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex1,"_qqplot_function.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq.plot(phenotype_sex1$p, main = paste("Q-Q plot of GWAS p-values:", phenotype, sex1))
dev.off()


png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex1,"_qqplot_qqman.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq(phenotype_sex1$p, main = paste("Q-Q plot of GWAS p-values:", phenotype, sex1), cex.lab =1.5, cex.axis=1.8, cex.main=2.0)
dev.off()
...
## make qq plots
png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex2,"_qqplot_function.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq.plot(phenotype_sex2$p, main = paste("Q-Q plot of GWAS p-values:", phenotype, sex2))
dev.off()


png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex2,"_qqplot_qqman.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq(phenotype_sex2$p, main = paste("Q-Q plot of GWAS p-values:", phenotype, sex2), cex.lab =1.5, cex.axis=1.8, cex.main=2.0)
dev.off()
...
## make qq plots
png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex3,"_qqplot_function.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq.plot(phenotype_sex3$p, main = paste("Q-Q plot of GWAS p-values:", phenotype, "both"))
dev.off()


png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex3,"_qqplot_qqman.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq(phenotype_sex3$p, main = paste("Q-Q plot of GWAS p-values:", phenotype, "both"), cex.lab =1.5, cex.axis=1.8, cex.main=2.0)
dev.off()
...
## make qq plots
png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex4,"_qqplot_function.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq.plot(phenotype_sex4$Pvalue, main = paste("Q-Q plot of GWAS p-values:", phenotype, sex4))
dev.off()


png(paste("/mnt/lustre/groups/ukbiobank/usr/chris/500k/output/body_composition/plots/qqplot/",phenotype,"_",sample,"_maf0.01_",sex4,"_qqplot_qqman.png", sep = ""),
    width = 960, height = 960, units = "px", pointsize = 12)
par(mar=c(6, 6, 4, 2) + 0.1)
qq(phenotype_sex4$Pvalue, main = paste("Q-Q plot of GWAS p-values:", phenotype, sex4), cex.lab =1.5, cex.axis=1.8, cex.main=2.0)
dev.off()
