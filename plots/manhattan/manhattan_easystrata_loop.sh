...
for j in "BFPC" "BMI" "FFM" "FM"; do for k in "c" "h" "af"; do R --vanilla < /mnt/lustre/groups/ukbiobank/usr/chris/500k/scripte/plotting/manhattan/manhattan_easystrata.R ${j} ${k}; done; done
